...
class MainActivity : AppCompatActivity() {
    ...
    private fun createOtt() {
        ...
        val top0 = 100
        otts = arrayListOf(
            Ott(mV("ה"), 0, 150, 150, 110 - int1, 0, 0, button0),
            ...
            Ott(mV("ה"), 6, scale1, scale1, 80, 0, 0, button1),

            Ott(mV("ה"), 7, scale1, scale1, 0, 0, 50, button1),
            ...
            Ott(mV("ה"), 11, scale1, scale1, 0, 0, 0+int2, button2),
